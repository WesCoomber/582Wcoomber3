...
maintains probability of next possible inputs by user when output of current
work is present to the user.
...
dynamically builds steroid in a form of bi conditional tree that is dataset,
program agnostic. 
