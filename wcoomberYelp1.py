...
def showPhotosOfBusinessID(businessID):
    if ((businessIDStars[businessID][0]) >= loadThreshold):
        print(businessIDStars[businessID][0], ' greater than or equal to loadThreshold value of ', loadThreshold)
        ...
        print(businessIDStars[businessID][0], ' less than loadThreshold value of ', loadThreshold, 'Program will not open the photos for the business!')
